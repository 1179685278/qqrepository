            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        data-title="用户列表" data-id="yhgl" data-url="http://localhost:8081/select.jsp">用户列表</a></dd>
                    </dl>
                </li>
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" class="side-nav-class"
                               data-title="权限列表" data-id="qxgl" data-url="http://localhost:8081/user/toquanpage">权限列表</a></dd>
                    </dl>
                </li>
                </shiro:hasRole>
            </ul>
